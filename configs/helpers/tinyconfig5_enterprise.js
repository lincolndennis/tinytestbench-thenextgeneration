...
var permanentpen = {
  external: {
    external_plugins: {
      'permanentpen': urlForPlugins + 'permanentpen/plugin.js'
    }
  },
  toolbar: {
    toolbarLocation: 1,
    toolbarButton: 'permanentpen'
  },
};
...
var formatpainter = {
  external: {
      external_plugins: {
          'formatpainter': urlForPlugins + 'formatpainter/plugin.js'
      }
    },
    toolbar: {
        toolbarLocation: 1,
        toolbarButton: 'formatpainter'
    },
};
...
var checklist = {
  external: {
      external_plugins: {
          'checklist': urlForPlugins + 'checklist/plugin.js'
      }
    },
    toolbar: {
        toolbarLocation: 1,
...
var casechange = {
  external: {
      external_plugins: {
          'casechange': urlForPlugins + 'casechange/plugin.js'
      }
    },
    toolbar: {
        toolbarLocation: 1,
        toolbarButton: 'casechange'
    },
};
...
var pageembed = {
  external: {
      external_plugins: {
          'pageembed': urlForPlugins + 'pageembed/plugin.js'
      }
    },
    toolbar: {
        toolbarLocation: 1,
        toolbarButton: 'pageembed'
    },
};
